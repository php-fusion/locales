<?php
$locale['bb_geshi_description'] = "GeSHi высвечивает код Utiliser";
$locale['bb_geshi_usage'] = "Подсветка кода для GeSHi Class";
$locale['bb_geshi_lang'] = "Кодовое языковое имя";
