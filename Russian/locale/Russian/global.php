...
$locale['select2'] = "ru"; // refer to path includes/jscripts/select2/select2_locale_{value}.js
...
$locale['global_133'] = "Оценка";
$locale['global_134'] = "Оценок";
...
$locale['global_301'] = "К сожалению, эта страница не может быть отображена. По каким-тоо причинам файлы темы оформления не были найдены.
 Если Вы администратор сайта, при помощи FTP-клиента загрузите тему оформелния, созданную для PHPFusion 8, в папку тем.
