...
$locale['select2'] = "tr"; // refer to path includes/jscripts/select2/select2_locale_{value}.js
...
$locale['global_142'] = "Tanımlanmış Anket Yok.";
$locale['global_143'] = "Derecelendirmeler";
// User Menu
$locale['UM060'] = "Giriş";
