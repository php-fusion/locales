...
$locale['u151'] = "Vítajte na ".$settings['sitename'];
$locale['u152'] = "Dobrý deň USER_NAME,\n
Vítajte na ".$settings['sitename'].". Tu sú vaše prihlasovacie údaje:\n
Meno: USER_NAME\n
Heslo: USER_PASSWORD\n
...
$locale['u154'] = "Prosím, kontaktujte <a href='".BASEDIR."contact.php'>administrátora</a>.";
...
// Avatar upload
$locale['u180'] = "Váš avatar prekračuje povolenú veľkosť súboru, limit je ".parsebytesize($settings['avatar_filesize']).".";
$locale['u181'] = "Váš avatar má nepodporovaný typ obrázka, podporované typy obrazov sú jpg, png and gif.";
$locale['u182'] = "Váš avatar prekračuje ".$settings['avatar_width']."x".$settings['avatar_height']." pixlov.";
$locale['u183'] = "Váš avatar sa nenahral správne.";
...
$locale['u192'] = "Podmienky dohody";
$locale['u193'] = "Obáznámte sa s <a href='".BASEDIR."print.php?type=T' target='_blank'>Podmienky dohody</a> a potvrdťe súhlas.";
$locale['u194'] = "Nesprávny overovací kód.";
$locale['u195'] = "Overovací modul(Captcha) nemôže byť prázdny.";

// E-mail Change Confirmation
$locale['u200'] = "Overovací email bude odoslaný na vašu novú emailovú adresu (%s).";
$locale['u201'] = "Vaša e-mailová adresa sa zmení, keď kliknete na odkaz v e-maile.";
$locale['u202'] = "Emailová adresa overená - ".$settings['sitename'];
$locale['u203'] = "Dobrý deň, [USER_NAME],\n
Niekto nastavil zmenu emailovej adresy vo vašom účte na našich stránkach\n
Ak naozaj chcete zmeniť svoju emailovú adresu, kliknite na nasledujúci odkaz:\n
[EMAIL_VERIFY_LINK]\n
Poznámka: musíte byť prihlásený na pokračovanie.\n\n
S pozdravom\n
