...
$locale['453'] = "Niniejszy login (".(isset($_POST['user_name']) ? $_POST['user_name'] : "")." is in use.";
$locale['454'] = "Podano nieprawidłowy adres e-mail.";
$locale['455'] = "Niniejszy adres e-mail (".(isset($_POST['user_email']) ? $_POST['user_email'] : "")." is in use.";
